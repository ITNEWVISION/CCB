...
/**
 * RebateClaimCancelReasonLookup is a class that represents the lookup field C1_REB_CLM_CAN_RSN_FLG
 * and its values:
   <table>
 ...
 */
public interface RebateClaimCancelReasonLookup extends com.splwg.ccb.api.lookup.RebateClaimCancelReasonLookup {
    ...
    public static class Constants {
        ...
        public RebateClaimCancelReasonLookup INVALID_DATA; 
        // Old Values

        public void initialize() {
            // new values
            INVALID_DATA = 
                LookupHelper.getLookupInstance(RebateClaimCancelReasonLookup.class, "BAD ");
