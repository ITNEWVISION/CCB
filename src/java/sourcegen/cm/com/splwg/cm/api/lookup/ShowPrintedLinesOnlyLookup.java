...
/**
 * ShowPrintedLinesOnlyLookup is a class that represents the lookup field SHOW_PRTLINES_SW
 * and its values:
   <table>
 ...
 */
public interface ShowPrintedLinesOnlyLookup extends Lookup {
    ...
    public static class Constants {
        ...
        public ShowPrintedLinesOnlyLookup YES; 
        // Old Values

        public void initialize() {
            // new values
            YES = 
                LookupHelper.getLookupInstance(ShowPrintedLinesOnlyLookup.class, "Y   ");
