...
/**
 * DataRevisedReasonLookup is a class that represents the lookup field C1_DATA_REV_RSN_FLG
 * and its values:
   <table>
 ...
 */
public interface DataRevisedReasonLookup extends com.splwg.ccb.api.lookup.DataRevisedReasonLookup {
    ...
    public static class Constants {
        ...
        public DataRevisedReasonLookup ILLEGIBLE; 
        // Old Values

        public void initialize() {
            // new values
            ILLEGIBLE = 
                LookupHelper.getLookupInstance(DataRevisedReasonLookup.class, "BAD ");
